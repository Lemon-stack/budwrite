    ...
    <div className="flex flex-col items-center">
      ...
      {showWaveform && (
        <div className="relative">
          <div className="top-14 -translate-x-1/2 absolute left-1/2 mb-2 h-16 w-32 rounded bg-card p-2">
            <canvas
              ref={canvasRef}
              width={128}
              height={64}
          ...
          <Button
            ...
            className="top-24 -right-18 absolute size-6 rounded-full p-0 hover:bg-red-500 hover:text-white transition-colors"
          >
            <X className="h-3 w-3" />
          </Button>
        </div>
      ...
      {isTranscribing ? (
        ...
        <Button
          ...
          variant="destructive"
          className="h-11 w-11 rounded-lg bg-gradient-to-tr from-green-600/50 via-green-500/50 via-50% to-sidebar-accent/50 to-97% text-white shadow-md hover:from-red-500 hover:via-red-500 hover:to-red-500 transition-all"
        >
        ...
        <Tooltip>
          <TooltipTrigger asChild>
            <Button
              ...
              className="flex h-11 w-11 items-center bg-transparent justify-center text-neutral-400 hover:bg-neutral-800 border-none hover:text-white transition-colors"
            >
              <Mic className="h-5 w-5" />
            </Button>
          </TooltipTrigger>
