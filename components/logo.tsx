...
<span className="bg-gradient-to-r from-purple-500 to-purple-700 shadow-sm rounded-md flex items-center justify-center p-1">
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width={24} height={24} color={"#f1f1f1"} fill={"none"} {...props}>
    ...
    <span className="text-2xl font-semibold">PictoStory</span>
    </div>
  );
